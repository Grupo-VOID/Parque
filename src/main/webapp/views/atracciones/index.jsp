			...
			<div class="col-4 tarjeta">
				<c:forEach items="${atraccion}" var="atraccion">
					<div class="card" style="width: 100%;">
						<img
								src="/Parque/assets/images/atracciones/<c:out value="${atraccion.imagen}"></c:out>"
								class="img-fluid" alt="...">
						...
						<div
							style="height: 120px; text-overflow: ellipsis; overflow: hidden; padding-top: 5mm">
						...
						<div class="modal fade bd-example-modal-lg"
							id="atraccion<c:out value="${atraccion.id}"></c:out>"
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-md-6">
													...
													<p>
														Cupo:
														<c:out value="${atraccion.cupoMaximo}"></c:out>
													</p>
												</div>
												<div class="col-md-6">
													<h2>
													...
													<div
														style="width: auto; height: 300px; overflow-y: scroll;">
														<c:out value="${atraccion.descripcion}"></c:out>
													</div>
												</div>
											</div>
